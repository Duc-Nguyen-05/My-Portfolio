...
export default async function CvRankingCaseStudy() {
    const filePath = path.join(process.cwd(), 'outline', 'Automated_CV_Ranking.md');
    let fileContent = '';
    try {
        fileContent = fs.readFileSync(filePath, 'utf-8');
    } catch (e) {
        fileContent = '# Lỗi tải nội dung\nKhông tìm thấy file outline/Automated_CV_Ranking.md';
    }
